...
$sql_update="UPDATE  users SET  first_name='".$dvar['first_name']."',last_name='".$dvar['last_name']."',email='".$dvar['email']."',phone_no='".$dvar['phone_no']."',fax='".$dvar['fax']."' where id='".$id."' " ;
  ...
  <?php include('include/header.php');?>
    ...
    <div id="container">
      ...
      <div id="content">
        ...
        <form enctype="multipart/form-data" method="post" action="<?php echo $_SERVER['PHP_SELF']?>?id=<?php echo $id;  ?>" onSubmit="function val()" >
     ...
     <a href="my_account.php" ><input type="submit" name="submit" class="button" value="Continue" onClick="my_account.php" style="width:80px; border-radius:2px; float:right; margin-top:7px;"></a>
