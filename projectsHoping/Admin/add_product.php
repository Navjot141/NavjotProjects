...
if($dvar['subcategory']=='')
	...
	{
		   $sql3="INSERT into product(subcategory,name,description,price,availability,featured,special,quantity,status,time)Values('".$dvar['subcategory']."','".$dvar['name']."','".$dvar['description']."','".$dvar['price']."','".$dvar['availability']."','".'1'."','".'1'."','".$dvar['quantity']."','".'1'."','".time()."')";
