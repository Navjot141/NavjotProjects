...
{    
 ...
 $num=mysql_num_rows($exec6);
	...
	if($fl==1)
	{
			...
			$sql4="UPDATE product SET subcategory='".$dvar['subcategory']."',name='".$dvar['name']."',description='".$dvar[ 'description']."',price='".$dvar['price']."',availability='".$dvar['availability']."',quantity='".$dvar['quantity']."' where id='".$id."'";
