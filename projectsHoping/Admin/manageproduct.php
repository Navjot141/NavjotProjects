...
{ 
 ...
 if($_GET['do']=="special"&& $_GET['id']<>"")
     {
	  $id=$_GET['id'];
	  $sql="UPDATE product SET special='0' where id='".$id."'";
	  $exec=mysql_query($sql) or die(mysql_query());
	    
 }
  if($_GET['do']=="special1"&& $_GET['id']<>"")
     {
	  $id=$_GET['id'];
	  $sql="UPDATE product SET special='1' where id='".$id."'";
	  $exec=mysql_query($sql) or die(mysql_query());
...
<div align="center">
  ...
  <form method="GET" action="<?php echo $_SERVER['PHP_SELF']?>">
              ...
              <div class="entry">
                ...
                <div class="position"><span class="text1">Special</span></div>
     ...
     while($fetch = mysql_fetch_assoc($exec)){
		 $val2=$fetch;?>
              <div class="entry">
                ...
                <div class="position"><span class="text">
                  <?php if($fetch['special']==1) {?>
                  <a href="<?php echo $_SERVER['PHP_SELF'];?>?do=special&id=<?php echo $fetch['id'];?>"><img src="images/enabled.gif" title="disable"/></a>
                  <?php  } else{ ?>
                  <a href="<?php echo $_SERVER['PHP_SELF'];?>?do=special1&id=<?php echo $fetch['id'];?>"><img src="images/disabled.gif" title="enable"/></a>
                  <?php  }       ?>
                  </span></div>
