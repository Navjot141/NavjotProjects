...
include 'config_dbase.php';
 $id=$_GET['id'];
  $sql="SELECT category.name as cat_name,subcategory.name as subcat_name, product.name as pdt_name,product.status as pdt_status from category left outer join subcategory on (category.id=subcategory.category) left outer join product on(subcategory.id=product.subcategory) where product.id='".$id."'";
...
<u>Product</u></span>
  ...
  <?php $i=0;
     ...
     ?>
     <tr >
<td width="200px" ><span style="font-size:20px">Category :</span>
</td>
<td width="200px;"><span style="font-size:20px">
 <?php echo $val2['cat_name']    ?> </span>
</td>
</tr>
<tr >
<td width="200px" ><span style="font-size:20px">Subcategory :</span>
</td>
<td width="200px;"><span style="font-size:20px">
 <?php echo $val2['subcat_name']    ?> </span>
</td>
</tr>
<tr >
<td width="200px" ><span style="font-size:20px">Product :</span>
</td>
<td width="200px;"><span style="font-size:20px">
<?php echo $val2['pdt_name']?></span>
</td>
</tr>
<tr >
...
<?php if($val2["pdt_status"] ==1){ echo "<span style='color:green'>Active</span>";} else{ echo "<span style='color:red'>Inactive</span>";}   ?></span>   
</td>
</tr>
 <tr >

                  <td width="200px" ><span style="font-size:20px">Product Image </span></td>
                  <td width="200px;"><span style="font-size:20px"> <img src="<?php if($fetch_q['image'] <> ""){echo '../uploadimage/'.$val2['image'];}?>"alt="" height="90px"; width="100px;"> </span></td>
                </tr>
