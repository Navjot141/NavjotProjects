    ...
    else
	{
     ...
     ?>
                <tr >
                  ...
                  <td width="200px;"><span style="font-size:20px"> <?php echo $fetch['cat_name'];?> </span></td>
                </tr>
                <tr >
                  <td width="200px" ><span style="font-size:20px">Subcategory :</span></td>
                  <td width="200px;"><span style="font-size:20px"> <?php echo $fetch['subcat_name']    ?> </span></td>
                </tr>
                <tr >
                  <td width="200px" ><span style="font-size:20px">Product :</span></td>
                  <td width="200px;"><span style="font-size:20px"> <?php echo $fetch['pdt_name']?></span></td>
                </tr>
                <tr > &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <td height="30px"><span style="font-size:20px">Status :</span></td>
                  <td><span style="font-size:20px; color:red;">
                    <?php if($fetch["pdt_status"] ==1){ echo "<span style='color:green'>Active</span>";} else{ echo "<span style='color:red'>Inactive</span>";}   ?>
                    </span></td>
                </tr>
                <tr >
                
                <?Php $sql="select * from product_image where product_id='".$fetch['pdt_id']."'";
				   $exec1=mysql_query($sql);
				   $i=1;
				  while($fetch_q=mysql_fetch_assoc($exec1)){?>
                  <td width="200px" ><span style="font-size:20px">Product Image<?php echo $i;?></span></td>
