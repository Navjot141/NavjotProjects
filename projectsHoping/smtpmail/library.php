...
define("SMTP_UNAME", "testing.slinfy02@gmail.com"); //Username for SMTP authentication any valid email created in your domain
define("SMTP_PWORD", "slinfy007"); //Password for SMTP authentication
