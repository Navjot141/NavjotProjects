...
include 'config.php';
$sql_about="SELECT * FROM about_us where status='1' AND  id='10'";
$exec_about=mysql_query($sql_about);
$sql_about1="SELECT * FROM about_us where status='1' AND  id='11'";
$exec_about1=mysql_query($sql_about1);
$sql_about2="SELECT * FROM about_us where status='1' AND  id='12'";
$exec_about2=mysql_query($sql_about2);
?>
<!DOCTYPE html>
<html dir="ltr" lang="en">
<head>
<meta charset="UTF-8" />
<title>Elements - Polishop eCommerce HTML Template</title>
  ...
  <div class="main-wrapper">
   ...
   <?php include('include/header.php');?>
    ...
    <div id="container">
      ...
      <!--Middle Part Start-->
      <div id="content">
        <div class="breadcrumb"><a href="index-2.html">Home</a> &raquo; <a href="#">Elements</a></div>
        <h1>Elements</h1>
        <!--Tabs Start-->
        <h4>Tabs</h4>
        <div id="tabs" class="htabs"> <a href="#tab-1">Title #1</a> <a href="#tab-2">Title #2</a> <a href="#tab-3">Title #3</a> </div> 
         <?php $i=0;while($fetch1=mysql_fetch_assoc($exec_about))  {?>
       ...
       <!-- <div id="tab-1" class="tab-content"> Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum. </div>-->
        <?php $i++;   }?>
         <?php $i=0;while($fetch2=mysql_fetch_assoc($exec_about1))  {?>
          <?php echo $fetch2['description']?>
      <!--  <div id="tab-2" class="tab-content"> Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. <br>
          ...
          It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum. </div> --> <?php $i++;   }?>
          <?php $i=0;while($fetch3=mysql_fetch_assoc($exec_about2))  {?>
           <?php echo $fetch3['description']?>
      <!--  <div id="tab-3" class="tab-content"> Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. <br>
          ...
          <br>
          It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum. </div>--><?php $i++;   }?>
        <script>
