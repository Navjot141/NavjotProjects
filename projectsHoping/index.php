...
<head>
<meta charset="UTF-8" />
<title>Shopzilla-a ecommerce site</title>
...
--></script>
        <!-- Nivo Slider End-->
        <!-- Welcom Text Start-->
        <div class="welcome">Welcome to ShopZilla</div>
        <p><strong>ShopZilla</strong>  is a ecommerce website. Electronic commerce, commonly known as e-commerce or ecommerce, is a type of industry where the buying and selling of products or services is conducted over electronic systems such as the Internet and other computer networks. Electronic commerce draws on technologies such as mobile commerce, electronic funds transfer, supply chain management, Internet marketing, online transaction processing, electronic data interchange (EDI), inventory management systems, and automated data collection systems.   <a href="#">BUY THEME</a>.</p>
        <!-- Welcom Text End-->
            ...
            <div class="box-product">
              <div class="flexslider special_carousel_tab">
                <ul class="slides">
                 <?Php
				 $countid="";
				  $sql_special="select product.*,product_image.image from product inner join product_image on
				 product.id=product_image.product_id where product.status='1' and product.special='1';";
					$exec_special=mysql_query($sql_special);
					while($fetch_special=mysql_fetch_assoc($exec_special)) 
					{
						if($countid!=$fetch_special['id'])	
					{
					?>
                  <li>
                    <div class="slide-inner">
                      <div class="image"><a href="product.php?prod_id=<?php echo $fetch_special['id'];?>&sub_id=<?php echo $fetch_special['subcategory']?>"><img src="uploadimage/<?php echo $fetch_special['image'];?>" height="170" width="170"></div>
                      <div class="name"><a href="product.php?prod_id=<?php echo $fetch_special['id'];?>&sub_id=<?php echo $fetch_special['subcategory']?>"><?php echo $fetch_special['name'];?></div>
                      <div class="price"> Rs <?php echo $fetch_special['price'];?></div>
                      <div class="cart">
                         <a href="index.php?do=addtocart&pid=<?php echo $fetch_special['id']?>"><input type="button" value="Add to Cart" class="button" /></a>
                      </div>
                      <div class="clear"></div>
                    </div>
                  </li>
