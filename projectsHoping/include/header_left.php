...
<?php while($fetch_subcat=mysql_fetch_assoc($exec_subcat)){
	 ...
	 ?>
                ...
                <ul>
                                    <li class="custom_id26"><a class="" href="category.php?main_id=<?php echo $fetch['id'];?>&sub_id=<?php echo $fetch_subcat['id']; ?>"><?php echo $fetch_subcat['name']; ?>(<?php echo $num_product;?>)</a></li>
