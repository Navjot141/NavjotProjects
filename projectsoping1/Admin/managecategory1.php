...
{ 
  ...
  $delete = $_POST['delete'];       
   ...
   { 
	...
	{ 
	   $sql5="DELETE  FROM category where id='".$v."'";
      ...
      <div class="header">
        ...
        <div class="content" >
          ...
          <div class="content1ba" >
            <div style="border:0px solid #999; width:100px; height:40px; float:left; font-size:22px; padding-top:8px; ">Category</div>
            <div class="content1ba1 " ><a href="add_editcategory.php"><span class="add1"></span> <span class="head">Category</span></a> </div>
            <div class="search1">
		 ...
		 $val2=$fetch;?>
            <div class="entry">
             ...
             <div class="position"><span class="text">
              ...
              <div class="position"><span class="text1a"> &nbsp;<a href="view_category.php?id=<?php echo $val2["id"];?>" style="color:#000;" title="view" ><img src="images/view.png" title="view" /> </a> &nbsp;&nbsp;&nbsp;&nbsp;<a href="edit_cat.php?do=edit&id=<?php echo $fetch["id"];?>" style="color:#6F6;"" title="edit" ><img src="images/edit.png" /></a> &nbsp;&nbsp;&nbsp;<a href="delete_category.php?id=<?php echo $val2["id"];?>" style="color:#F00;;" title="delete" ><img src="images/delete.png" title="delete" /></a> </span></div>
            </div>
            <?php $i++;}}?>
          <div class="clear"></div>
