      ...
      <?php include 'header.php'; ?>
        <div class="content" >
          ...
          <div class="content1ba" >
            ...
            <div class="content1ba1 " ><a href="addcategory.php"><span class="add1"></span> <span class="head">Category</span></a> </div>
            <div class="search1">
...
?>
            <div class="entry">
             ...
             <div class="position"><span class="text">
              ...
              <div class="position"><span class="text1a"> &nbsp;
 <a href="view_category.php?id=<?php echo $fetch
 ["id"];?>" style="color:#000;" title="view" ><img src="images/view.png" title="view" /> </a>&nbsp;&nbsp;&nbsp;&nbsp;
 <a href="edit_category.php?do=edit&id=<?php echo $fetch["id"];?>" style="color:#6F6;"" title="edit" ><img src="images/edit.png" /></a> &nbsp;&nbsp;&nbsp;
 <a href="deletecategory.php?id=<?php echo $fetch["id"];?>" style="color:#F00;;" title="delete" ><img src="images/delete.png" title="delete" /></a> </span></div>
            </div>
            <?php ;}?>
          <div class="clear"></div>
