...
include 'config_db.php';
 $id=$_GET['id'];
   $sql="Select category.name as cat_name,subcategory.name as subcat_name ,subcategory.status as subcat_status FROM category left outer join subcategory ON category.id=subcategory.category
...
<?php if($val2["subcat_status"] ==1){ echo "<span style='color:green'>Active</span>";} else{ echo "<span style='color:red'>Inactive</span>";}   ?></span>
</td>
</tr>
<tr>
<td colspan="2">
