...
if($dvar['subcategory']=='')
	...
	{
		$sql3="INSERT into product(subcategory,name,description,price,availability,quantity,status,time)Values('".$dvar['subcategory']."','".$dvar['name']."','".$dvar['description']."','".$dvar['price']."','".$dvar['availability']."','".$dvar['quantity']."','".'1'."','".time()."')";
  ...
  <div class="outerdiv">
    <div class="innerdiv">
              ...
              <table border="0" vspace="40px;" >
                ...
                <tr >
                 ...
                 <tr>
                  ...
                  <td><input type="text" name="price" value="" class="textbox" /></td>
                </tr>
                 <tr >
      ...
      <span style="color:red" >Out of  stock</span> </span></td>
                  ...
                  <td><input type="text" name="quantity" value="" class="textbox" /></td>
                </tr>
                <tr>
