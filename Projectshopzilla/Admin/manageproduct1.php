            ...
            <div class="content1b">
              ...
              <div style="float:left;">
               ...
               <div class="entry">
                ...
                <div class="position2"><span class="text1">Description</span></div>
                <div class="position2"><span class="text1">Price</span></div>
...
<?php */?>                  </span></div>
                ...
                <div class="position1a"><span class="text1a"> &nbsp;<a href="view_prod.php?id=<?php echo $val2["id"];?>"  style="color:#000;" title="view" ><img src="images/view.png" title="view" /> </a> &nbsp;&nbsp;&nbsp;&nbsp;<a href="add_editproduct.php?do=edit&id=<?php echo $val2["id"];?>&page=<?php echo $page;?>" style="color:#6F6;"" title="edit" ><img src="images/edit.png" /></a> &nbsp;&nbsp;&nbsp;<a href="manageproduct.php?go=del&id=<?php echo $val2["id"];?>" style="color:#F00;;" title="delete" ><img src="images/delete.png" title="delete" /></a> </span></div>
              </div>
              <?php $i++;}}?>
   <div style="float:left; margin-left:200px; margin-top:50px;"> <?php /*?><?php	echo pagination($statement,$limit,$page);?><?php */?></div>
   <div class="clear"></div>
