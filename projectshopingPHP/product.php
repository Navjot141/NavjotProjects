...
</script><!--<a href="#"><img src="image/product/small-banner1-220x350.jpg" alt="banner" title="banner" /></a>--></div>
        </div>
        <!--Banner End-->
      </div>
      <!--Left End-->
				...
				?>
                  <li>
                    <div class="slide-inner">
                      ...
                      <div class="cart">
                    <a href="product.php?do=addtocart&pid=<?php echo $fetch_related['id']?>&prod_id=<?php echo $fetch_related['id'];?>&sub_id=<?php echo $fetch_related['subcategory'];?>"><input type="button" value="Add to Cart" class="button" /></a>
                      </div>
                      <div class="clear"></div>
                    </div>
                  </li>
