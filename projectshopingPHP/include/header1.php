 ...
 <header id="header">
      ...
      <?php  }
        ...
        <a href="login.php">Login</a> <a href="regi1.php">Register</a>
         <a href="login.php">My Account</a> <a href="checkout.php">Checkout</a>
        <?php 
		}
		?>  
...
?>
            ...
            <div class="checkout"><a class="button" href="cart.php">View Cart</a> &nbsp; <a class="button" href="checkout.html">Checkout</a></div>
              ...
              <div class="column"><a href="category.php?main_id=<?php echo $fetch['id'];?>"><?php echo $fetch['name'];?></a>
               ...
               <div>
				  ...
				  <?php while($fetch_subcat=mysql_fetch_assoc($exec_subcat)){ ?>
                    <li><a href="category.php?main_id=<?php echo $fetch['id'];?>&sub_id=<?php echo $fetch_subcat['id']; ?>" ><?php echo $fetch_subcat['name'];?></a></li>
                    <?php }?>
                    <!--<li><a href="category.php">Desktops (0)</a></li>
                    <li><a href="category.php">Components (1)</a></li>
                    <li><a href="category.php">Software (1)</a></li>
                    <li><a href="category.php">Phones &amp; PDAs (4)</a></li>
                    <li><a href="category.php">Cameras (2)</a></li>-->
                ...
                <?php $i++; } ?>
                 <!--  <div class="column"> <a href="category.php">Jewellery</a>
                <div>
                  <ul>
                    <li><a href="category.php">Children's Jewellery (0)</a></li>
                    <li><a href="category.php">Men's Jewellery (1)</a></li>
                    <li><a href="category.php">Women's Jewellery (0)</a></li>
                    <li><a href="category.php">Sample Test (0)</a></li>
                    <li><a href="category.php">Sample Test11 (0)</a></li>
                    <li><a href="category.php">Sample Test12 (0)</a></li>
                  </ul>
                </div>
              </div>-->
          <!--    <div class="column"> <a href="category.php">Shoes</a>
                <div>
                  <ul>
                    <li><a href="category.php">Children's Shoes (1)</a></li>
                    <li><a href="category.php">Men's Shoes (2)</a></li>
                    <li><a href="category.php">Women's Shoes (1)</a></li>
                    <li><a href="category.php">Test Sample (0)</a></li>
                    <li><a href="category.php">Test Sample1 (0)</a></li>
                  </ul>
                </div>
              </div>
              <div class="column"> <a href="category.html">Clothing</a>
                <div>
                  <ul>
                    <li><a href="category.php">Men (1)</a></li>
                    <li><a href="category.php">Women (1)</a></li>
                    <li><a href="category.php">Boys (0)</a></li>
                    <li><a href="category.php">Girls (0)</a></li>
                    <li><a href="category.php">Accessories (0)</a></li>
                    <li><a href="category.php">Sample Test21 (0)</a></li>
                  </ul>
                </div>
              </div>
