...
<head>
<meta charset="UTF-8" />
<title>Privacy policy - Polishop eCommerce HTML Template</title>
...
<div class="wrapper-box">
  <div class="main-wrapper">
    ...
    <div id="container">
      ...
      <div id="content">
      <?php 
		$sql_privacy="select * from about_us where id='8'";
		$exec_privacy=mysql_query($sql_privacy);
		$fetch=mysql_fetch_assoc($exec_privacy);
		 ?>
